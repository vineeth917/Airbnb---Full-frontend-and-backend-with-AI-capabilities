...
-- Insert demo users (passwords: 'traveler123' and 'host123456' hashed with bcrypt)
...
('demo-host-1', 'host', 'host@airbnb.com', '$2b$10$Kw3H/smWixO1vyqhQzEcPe9wqe7Jyo9XhKwz.WauPvlCrcaPY1IoC', 'owner', 'Jane', 'Smith', 'Miami', 'USA');
...
INSERT INTO bookings (id, listing_id, guest_id, host_id, check_in, check_out, total_price, status) VALUES
('booking-1', 'listing-1', 'demo-traveler-1', 'demo-host-1', '2025-10-25', '2025-10-28', 345.00, 'confirmed'),
('booking-2', 'listing-2', 'demo-traveler-1', 'demo-host-1', '2025-11-01', '2025-11-05', 916.00, 'pending');
